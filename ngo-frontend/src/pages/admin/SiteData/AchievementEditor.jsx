...
export default function AchievementEditor() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await updateAchievementData(fd);

            toast.success("Achievement Updated!", { id: toastId });
            await loadData();
        } catch (err) {
            console.error(err);
    ...
    return (
        <div className="max-width">
            ...
            <div className="sticky-header d-flex justify-content-between align-items-center mb-3">
                <div>
                    <ol className="breadcrumb mb-1">
                        ...
                        <li className="breadcrumb-item active">Achievement</li>
                    </ol>
                    <h4 className="fw-semibold mb-0">Edit Achievement</h4>
                </div>
            ...
            <div className="card p-4 shadow-sm">
                ...
                {/* IMAGE UPLOAD */}
                <h6 className="fw-bold text-uppercase mb-3">Achievement Image</h6>
                ...
                {/* TEXT FIELDS */}
                <h6 className="fw-bold text-uppercase mb-3">Achievement Details</h6>
