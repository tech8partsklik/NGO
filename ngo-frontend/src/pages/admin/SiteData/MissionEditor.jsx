...
export default function MissionEditor() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            await updateMissionData(fd);

            toast.success("Mission Updated!", { id: toastId });
            await loadData();
        } catch (err) {
            console.error(err);
            toast.error("Failed to update mission", { id: toastId });
        } finally {
            setSaving(false);
        }
    };
    ...
    if (loading)
        return (
            <div className="max-width">
                <div className="card p-4 shadow-sm">Loading mission...</div>
            </div>
        );
        ...
        <div className="max-width">
            <div className="sticky-header d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <h4 className="fw-semibold mb-0">Edit Mission</h4>
                </div>
            ...
            <div className="card p-4 shadow-sm">
                ...
                <h6 className="fw-bold text-uppercase mb-3">Mission Image</h6>
                <MediaUploader label="Mission Image" accept="image" multiple={false} onChange={onFileChange} value={filePreview || null} />

                <hr className="my-4" />

                <h6 className="fw-bold text-uppercase mb-3">Mission Details</h6>

                <div className="row g-3">

                    <div className="col-md-6">
                        <label className="form-label">Title</label>
                        <input ref={inputRef} className="form-control" value={form.title} onChange={(e) => setForm({ ...form, title: e.target.value })} />
                    </div>
                    ...
                    <div className="col-12">
                        ...
                        <RichTextEditor height={200} value={form.html_body} onChange={(content) => setForm({ ...form, html_body: content })} />
                    </div>
                </div>
                ...
                <div className="row g-3">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="input-group">
                            ...
                            <input className="form-control rounded-start-0" value={form.whatsapp_number}
