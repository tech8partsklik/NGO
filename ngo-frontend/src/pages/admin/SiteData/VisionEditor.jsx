...
export default function VisionEditor() {
    ...
    const handleSubmit = async () => {
        ...
        setSaving(true);
        const toastId = toast.loading("Updating vision...");
        ...
        try {
            ...
            await updateVisionData(fd);

            toast.success("Vision Updated!", { id: toastId });
            await loadData();
        } catch (err) {
            console.error(err);
            toast.error("Failed to update vision", { id: toastId });
        } finally {
            setSaving(false);
        }
    };
    ...
    if (loading)
        return (
            <div className="max-width">
                <div className="card p-4 shadow-sm">Loading vision...</div>
            </div>
        );
        ...
        <div className="max-width">
            <div className="sticky-header d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <h4 className="fw-semibold mb-0">Edit Vision</h4>
                </div>
            ...
            <div className="card p-4 shadow-sm">
                ...
                <h6 className="fw-bold text-uppercase mb-3">Vision Image</h6>
                <MediaUploader label="Vision Image" accept="image" multiple={false} onChange={onFileChange} value={filePreview || null} />

                <hr className="my-4" />

                <h6 className="fw-bold text-uppercase mb-3">Vision Details</h6>

                <div className="row g-3">

                    <div className="col-md-6">
                        <label className="form-label">Title</label>
                        <input ref={inputRef} className="form-control" value={form.title}
                    ...
                    <div className="col-12">
                        ...
                        <RichTextEditor height={200} value={form.html_body}
